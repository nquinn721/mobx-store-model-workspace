...
var Store = /** @class */ (function (_super) {
  ...
  function Store(model) {
    ...
    if (_this.current.getParams) _this.getParams = _this.current.getParams;
    return _this;
  }
    ...
    return __awaiter(this, void 0, void 0, function () {
      ...
      return __generator(this, function (_a) {
        this.waitingToSave.forEach(function (v, i) {
          if (v.type === 'create') _this.create(v.data);
          else _this.update(v.data);
        });
        this.waitingToSave = [];
        return [2 /*return*/];
      });
        ...
        switch (_a.label) {
          ...
          case 1:
            ...
            mobx_1.runInAction(function () {
              ...
              } else _this.fetchDataFailed = true;
              _this.fetchingData = false;
            });
        ...
        switch (_a.label) {
          ...
          case 1:
            ...
            if (!d.error) {
              ...
              this.addObject(m);
              this.setSaveSuccess();
            } else this.setSaveFailed({ type: 'create', data: data });
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          ...
          case 1:
            ...
            else this.setSaveFailed({ type: 'update', data: data });
            this.savingData = false;
            return [2 /*return*/, d];
        }
      });
    ...
    return __awaiter(this, void 0, void 0, function () {
      return __generator(this, function (_a) {
        switch (_a.label) {
          ...
          case 2:
            return [4 /*yield*/, this.createCurrent(dontReset)];
          case 3:
            return [2 /*return*/, _a.sent()];
        }
      });
  ...
  Store.prototype.createCurrent = function (dontReset) {
    return __awaiter(this, void 0, void 0, function () {
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            return [4 /*yield*/, this.create(this.current)];
          case 1:
            d = _a.sent();
            if (!d.error) {
              this.addObject(d);
  ...
  Store.prototype.updateCurrent = function (dontReset) {
    return __awaiter(this, void 0, void 0, function () {
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            return [4 /*yield*/, this.update(this.current)];
          case 1:
            d = _a.sent();
            if (!d.error) {
              this.addObject(d);
  ...
  Store.prototype.deleteCurrent = function () {
    return __awaiter(this, void 0, void 0, function () {
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            return [4 /*yield*/, this.delete(this.current.id)];
          case 1:
            d = _a.sent();
            this.resetCurrent();
            return [2 /*return*/, d];
  ...
  Store.prototype.setSaveSuccess = function () {
    ...
    setTimeout(function () {
      return (_this.saveSuccess = false);
    }, 3000);
  };
  ...
  Store.prototype.getById = function (id) {
    return __awaiter(this, void 0, void 0, function () {
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            p = this.objects.find(function (v) {
              return v.id === id;
            });
  ...
  Store.prototype.getByIdSync = function (id) {
    return this.objects.find(function (v) {
      return v.id === id;
    });
  };
  Store.prototype.getMultipleById = function (ids) {
    ...
    return this.objects.filter(function (v) {
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            str = '?s=';
            searchParams = {};
            ids = this.objects.map(function (v) {
              return v.id;
            });
            for (i in obj) searchParams[i] = { $contL: obj[i] };
  ...
  Store.prototype.constructGetParams = function (obj) {
    var str = '';
    for (var i in obj)
      str += paramConstructor_1.ParamConstructor[i]
        ? paramConstructor_1.ParamConstructor[i](obj[i]) + '&'
        : i + '=' + obj[i];
  ...
  Store.prototype.addObject = function (obj) {
    if (
      ...
      var o = this.objects.find(function (a) {
        return a.id === obj.id;
      });
      Object.assign(o, obj);
    }
  ...
  Store.prototype.removeObject = function (obj) {
    this.objects = this.objects.filter(function (v) {
      return v.id !== obj.id;
    });
  };
  __decorate([mobx_1.observable], Store.prototype, 'objects', void 0);
  __decorate([mobx_1.observable], Store.prototype, 'current', void 0);
  __decorate([mobx_1.observable], Store.prototype, 'hydrated', void 0);
  __decorate([mobx_1.observable], Store.prototype, 'initLoaded', void 0);
  __decorate([mobx_1.observable], Store.prototype, 'ready', void 0);
  __decorate([mobx_1.observable], Store.prototype, 'fetchingData', void 0);
  __decorate([mobx_1.observable], Store.prototype, 'fetchDataFailed', void 0);
  __decorate([mobx_1.observable], Store.prototype, 'fetchDataSuccess', void 0);
  __decorate([mobx_1.observable], Store.prototype, 'savingData', void 0);
  __decorate([mobx_1.observable], Store.prototype, 'saveSuccess', void 0);
  __decorate([mobx_1.observable], Store.prototype, 'saveFailed', void 0);
  __decorate([mobx_1.observable], Store.prototype, 'deleteSuccess', void 0);
  __decorate([mobx_1.observable], Store.prototype, 'deleteFailed', void 0);
  __decorate([mobx_1.action], Store.prototype, 'refreshData', null);
  __decorate([mobx_1.action], Store.prototype, 'retrySave', null);
  __decorate([mobx_1.action.bound], Store.prototype, 'initLoad', null);
  __decorate([mobx_1.action.bound], Store.prototype, 'setHydrated', null);
  __decorate([mobx_1.action], Store.prototype, 'checkIsLoaded', null);
  __decorate([mobx_1.action], Store.prototype, 'getData', null);
  __decorate([mobx_1.action], Store.prototype, 'create', null);
  __decorate([mobx_1.action], Store.prototype, 'update', null);
  __decorate([mobx_1.action], Store.prototype, 'delete', null);
  __decorate([mobx_1.action.bound], Store.prototype, 'saveCurrent', null);
  __decorate([mobx_1.action.bound], Store.prototype, 'createCurrent', null);
  __decorate([mobx_1.action.bound], Store.prototype, 'updateCurrent', null);
  __decorate([mobx_1.action.bound], Store.prototype, 'deleteCurrent', null);
  __decorate([mobx_1.action.bound], Store.prototype, 'resetCurrent', null);
  __decorate([mobx_1.action.bound], Store.prototype, 'setCurrent', null);
  __decorate([mobx_1.action], Store.prototype, 'setSaveSuccess', null);
  __decorate([mobx_1.action], Store.prototype, 'setSaveFailed', null);
  __decorate([mobx_1.action.bound], Store.prototype, 'getById', null);
  __decorate([mobx_1.action], Store.prototype, 'search', null);
  __decorate([mobx_1.action.bound], Store.prototype, 'addObject', null);
  __decorate([mobx_1.action.bound], Store.prototype, 'removeObject', null);
  return Store;
