...
var Model = /** @class */ (function () {
  ...
  Model.prototype.convertForSave = function (data) {
    ...
    for (var i in obj) if (typeof obj[i] === 'undefined' || this.propsToDeleteForSave.includes(i)) delete obj[i];
  ...
  Model.prototype.reset = function () {
    var model = this;
    for (var i in this.original) if (i !== 'original') model[i] = this.original[i];
  };
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            return [
              4 /*yield*/,
              service_1.Service.get(this.route + '/' + this.id + this.constructGetParams(this.getParams)),
            ];
          case 1:
            _a.sent();
            this.convertFromLoad();
  ...
  Model.prototype.constructGetParams = function (obj) {
    var str = '';
    for (var i in obj) str += paramConstructor_1.ParamConstructor[i](obj[i]) + '&';
  ...
  __decorate([mobx_1.observable], Model.prototype, 'editable', void 0);
  __decorate([mobx_1.observable], Model.prototype, 'saved', void 0);
  return Model;
})();
exports.Model = Model;
